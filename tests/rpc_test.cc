...
TEST_SUITE("rpc") {
    ...
    TEST_CASE("Codec handles incomplete buffer") {
        Message msg = capnp_util::make<msg::Message>();
        auto builder = capnp_util::builder<msg::Message>(msg);
        builder.setMsgType(static_cast<MessageType>(static_cast<int>(MessageType::MSG_HEARTBEAT)));
        builder.setFrom(1);
        builder.setTo(2);
    ...
    TEST_CASE("Codec rejects oversized message") {
        Message msg = capnp_util::make<msg::Message>();
        auto builder = capnp_util::builder<msg::Message>(msg);
        builder.setMsgType(static_cast<MessageType>(static_cast<int>(MessageType::MSG_SNAPSHOT)));
        builder.setFrom(1);
        builder.setTo(2);
