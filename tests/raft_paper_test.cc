...
TEST_CASE("raft paper: leader election in one round rpc") {
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        for (const auto& [id, vote] : votes) {
            Message m = capnp_util::make<msg::Message>();
            auto builder = capnp_util::builder<msg::Message>(m);
            builder.setMsgType(static_cast<::raftpp::capnp::MessageType>(static_cast<int>(MessageType::MSG_REQUEST_VOTE_RESPONSE)));
            builder.setFrom(id);
            builder.setTo(1);
...
TEST_CASE("raft paper: follower vote") {
    ...
    for (size_t i = 0; i < tests.size(); ++i) {
        ...
        Message m = capnp_util::make<msg::Message>();
        auto builder = capnp_util::builder<msg::Message>(m);
        builder.setMsgType(static_cast<::raftpp::capnp::MessageType>(static_cast<int>(MessageType::MSG_REQUEST_VOTE)));
...
TEST_CASE("raft paper: candidate fallback") {
    ...
    m1_builder.setMsgType(static_cast<::raftpp::capnp::MessageType>(static_cast<int>(MessageType::MSG_APPEND)));
    ...
    m2_builder.setMsgType(static_cast<::raftpp::capnp::MessageType>(static_cast<int>(MessageType::MSG_APPEND)));
