...
void RawNode::TransferLeader(const uint64_t transferee) {
    ...
    builder.setMsgType(static_cast<::raftpp::capnp::MessageType>(
        static_cast<int>(MessageType::MSG_TRANSFER_LEADER)
    ));
...
void RawNode::ReadIndex(const std::string& ctx) {
    ...
    auto builder = capnp_util::builder<msg::Message>(m);
    builder.setMsgType(
        static_cast<::raftpp::capnp::MessageType>(static_cast<int>(MessageType::MSG_READ_INDEX))
    );
...
void RawNode::ReportUnreachable(uint64_t id) {
    ...
    auto builder = capnp_util::builder<msg::Message>(m);
    builder.setMsgType(
        static_cast<::raftpp::capnp::MessageType>(static_cast<int>(MessageType::MSG_UNREACHABLE))
    );
    builder.setFrom(id);
    std::ignore = raft_.Step(m);
}
...
Result<void> RawNode::Propose(const std::string& ctx, const std::string& data) {
    ...
    m_builder.setMsgType(
        static_cast<::raftpp::capnp::MessageType>(static_cast<int>(MessageType::MSG_PROPOSE))
    );
...
Result<void> RawNode::ProposeConfChange(const std::string& ctx, const ConfChangeV2& cc) {
    ...
    entry_builder.setEntryType(
        static_cast<::raftpp::capnp::EntryType>(static_cast<int>(EntryType::ENTRY_CONF_CHANGE_V2))
    );
